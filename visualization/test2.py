...
field = box(pos = (0, 0, 0), size = (300, 10, 100), color = color.green, opacity = 0.3)
...
yaxis = PhysAxis(field, 5, # 5 tick marks
    ...
    startPos = (-150, 0, 0), # start the y axis at the left edge of the scene
...
ball.pos = (-150, 0, 0) # initial position of the ball in(x, y, z) form, units are in meters
ball.v = (30, 40, 0) # initial velocity of car in (vx, vy, vz) form, units are m/s

g = (0, -9.8, 0) # acceleration due to gravity; units are m/s/s
